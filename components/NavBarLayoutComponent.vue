  ...
  <header class="h-auto">
    ...
    >
      <div class="flex w-full lg:ml-8">
        <div class="flex flex-col content-center flex-wrap w-full space-x-4">
          <div class="lg:ml-20">
            <div class="flex lg:flex-1 justify-center">
              <NuxtLink to="/Home" class="lg:mb-2 lg:p-1.5">
                <img
            ...
            <PopoverGroup class="hidden lg:flex lg:gap-x-5">
              ...
              >
                <p class="hover:font-bold text-shadow-xl">HOME</p></NuxtLink
              >
        ...
        <div class="hidden lg:flex flex-row items-baseline justify-end">
          <div class="h-full flex items-end m-0">
            <img
              class="w-[75px] object-contain align-bottom"
