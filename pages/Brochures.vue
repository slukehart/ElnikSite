  ...
  <div class="flex flex-col">
    ...
    <div class=" w-full lg:flex lg:flex-row md:flex-col sm:block justify-between items-center bg-gray-200">
      <div class="flex flex-col lg:justify-start md:items-center sm:items-center lg:w-1/2  space-y-6">
        <h1 class="text-5xl text-shadow-md font-bold" style="font-family: ITCFranklinGothicStd-Demi">BROCHURES</h1>
...
<!--          <button-->
<!--            class="h-auto mt-4 btn-product w-3/4 text-sm hover:bg-blue-600 text-white font-bold py-2 px-4"-->
<!--          >-->
<!--           Contact Us-->
<!--          </button>-->
          </a>
